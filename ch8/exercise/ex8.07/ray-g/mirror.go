...
func crawl(url string, depth int, wg *sync.WaitGroup) {
	...
	for _, link := range urls {
		...
		seenLock.Unlock()
		wg.Add(1)
		go crawl(link, depth+1, wg) // crawl concurrently and recursively
	}
}
...
func visit(rawurl string) (urls []string, err error) {
	...
	// TODO: add this segment to my fetcher project
...
// If resp.Body has already been consumed, `body` can be passed and will be read instead.
